...
export function Environment(name: string): BaseURL {
    return `https://${name}-bank-statement-ai-crhi.encr.app`
}
...
/**
 * Client is an API client for the bank-statement-ai-crhi Encore application.
 */
export default class Client {
    public readonly cards: cards.ServiceClient
    public readonly statements: statements.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.statements = new statements.ServiceClient(base)
...
export namespace cards {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.ListBanks = this.ListBanks.bind(this)
            this.ListCards = this.ListCards.bind(this)
        }

        public async CreateCard(params: CreateCardParams): Promise<Card> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/cards`, JSON.stringify(params))
            return await resp.json() as Card
        }

        public async GetCard(id: string): Promise<Card> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/cards/${encodeURIComponent(id)}`)
            return await resp.json() as Card
        }

        public async ListBanks(): Promise<ListBanksResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/banks`)
            return await resp.json() as ListBanksResponse
        }

        public async ListCards(): Promise<ListCardsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/cards`)
            return await resp.json() as ListCardsResponse
        }
    }
}
...
export namespace statements {
    ...
    export class ServiceClient {
        ...
        public async GetStatement(id: string): Promise<Statement> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/statements/${encodeURIComponent(id)}`)
        ...
        public async UpdateBalance(id: string, params: UpdateBalanceParams): Promise<Statement> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PATCH", `/statements/${encodeURIComponent(id)}/balance`, JSON.stringify(params))
            return await resp.json() as Statement
        }
...
export namespace transactions {
    ...
    export class ServiceClient {
        ...
        public async GetTransaction(id: string): Promise<Transaction> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/transactions/${encodeURIComponent(id)}`)
         ...
         */
        public async ListTransactions(params: ListTransactionsParams): Promise<ListTransactionsResponse> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                "card_id":      params.CardID,
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/transactions`, undefined, {query})
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "bank-statement-ai-crhi-Generated-TS-Client (Encore/v1.56.7)";
        }
